...
SELECT category_id, 'Mehandi Leaves (Fresh)', 'Lawsonia inermis', 'Freshly harvested Mehandi (Gorintaku) leaves, carefully packed for freshness. Ideal for preparing natural henna paste and for use during traditional festivals, pujas, weddings, and other auspicious occasions.', 18, 93, NULL, 'LEA-COS-001', '100 gm'
...
UPDATE products SET weight = '100 gm' WHERE product_name = 'Mehandi Leaves (Fresh)' AND weight IS NULL;
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Turmeric Powder', 'Curcuma longa', 'Pure, stone-ground turmeric powder made from sun-dried rhizomes. Widely used in cooking, skincare routines, and traditional remedies.', 9.99, 150, NULL, 'SPI-PWD-001', NULL
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Betel Leaves', 'Piper betle', 'Fresh betel leaves, traditionally used in paan and religious ceremonies.', 0.85, 966, NULL, 'LEA-RIT-001', NULL
FROM categories WHERE category_name = 'Leaves'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Mango Leaves', 'Mangifera indica', 'Fresh mango leaves, used for festive door decorations (toranam) and religious occasions.', 3.5, 92, NULL, 'LEA-RIT-002', NULL
FROM categories WHERE category_name = 'Leaves'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Neem Leaves', 'Azadirachta indica', 'Fresh neem leaves, used in traditional remedies and religious rituals.', 3, 100, NULL, 'LEA-RIT-003', NULL
FROM categories WHERE category_name = 'Leaves'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Bhel Patra', 'Aegle marmelos', 'Bilva (bel) leaves, traditionally offered during Shiva puja.', 1, 80, NULL, 'LEA-RIT-004', NULL
FROM categories WHERE category_name = 'Leaves'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Amla Pickle', NULL, 'Traditional Andhra-style amla (Indian gooseberry) pickle.', 6, 50, NULL, 'PIK-VEG-001', NULL
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Andhra Avakaya Pickle (Mango)', NULL, 'Traditional spicy Andhra mango pickle made with raw mango, red chilli, and mustard.', 6, 50, NULL, 'PIK-VEG-002', NULL
FROM categories WHERE category_name = 'Pickle Items'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Andhra Tomato Pickle', NULL, 'Spicy Andhra-style tomato pickle.', 5.85, 50, NULL, 'PIK-VEG-003', NULL
FROM categories WHERE category_name = 'Pickle Items'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Bittergourd Pickle', NULL, 'Andhra-style bitter gourd pickle.', 5.85, 50, NULL, 'PIK-VEG-004', NULL
FROM categories WHERE category_name = 'Pickle Items'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Brinjal Pickle', NULL, 'Traditional brinjal (eggplant) pickle.', 5.85, 50, NULL, 'PIK-VEG-005', NULL
FROM categories WHERE category_name = 'Pickle Items'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Gongura Pickle', NULL, 'Traditional Andhra gongura (sorrel leaves) pickle, tangy and spicy.', 6, 50, NULL, 'PIK-VEG-006', NULL
FROM categories WHERE category_name = 'Pickle Items'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Green Chilli Pickle', NULL, 'Spicy green chilli pickle.', 5.85, 50, NULL, 'PIK-VEG-007', NULL
FROM categories WHERE category_name = 'Pickle Items'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Karivepaku Pickle', NULL, 'Curry leaves pickle, aromatic and spicy, an Andhra specialty.', 5.92, 50, NULL, 'PIK-VEG-008', NULL
FROM categories WHERE category_name = 'Pickle Items'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Kothimeera Pickle', NULL, 'Coriander leaves pickle, a tangy Andhra specialty.', 5.92, 50, NULL, 'PIK-VEG-009', NULL
FROM categories WHERE category_name = 'Pickle Items'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Drumstick Pickle', NULL, 'Traditional drumstick (moringa) pickle.', 5.78, 50, NULL, 'PIK-VEG-010', NULL
FROM categories WHERE category_name = 'Pickle Items'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Anand Finger Millets', 'Eleusine coracana', 'Finger millet flour, a nutritious traditional grain.', 6.99, 9, NULL, 'GRO-GRN-001', NULL
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Anand Little Millet', 'Panicum sumatrense', 'Little millet, a traditional nutritious grain.', 6.99, 6, NULL, 'GRO-GRN-002', NULL
FROM categories WHERE category_name = 'Grocery'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Premium Small Peanuts', 'Arachis hypogaea', 'Small variety raw peanuts.', 8.99, 2, NULL, 'GRO-NUT-001', NULL
FROM categories WHERE category_name = 'Grocery'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Deep Sooji Rava', NULL, 'Fine semolina (sooji/rava), used for upma, halwa and more.', 4.99, 16, NULL, 'GRO-GRN-003', NULL
FROM categories WHERE category_name = 'Grocery'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Bambino Roasted Vermicelli', NULL, 'Roasted vermicelli, ready for upma and kheer preparations.', 2.49, 6, NULL, 'GRO-GRN-004', NULL
FROM categories WHERE category_name = 'Grocery'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Idli Karam Podi', NULL, 'Spiced lentil powder traditionally eaten with idli and dosa.', 6.28, 20, NULL, 'KAR-PWD-001', NULL
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Kandi Karam Podi', NULL, 'Toor dal-based spice powder, a staple Andhra side for rice.', 6.28, 20, NULL, 'KAR-PWD-002', NULL
FROM categories WHERE category_name = 'Karam Powders'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Karivepaku Karam Podi', NULL, 'Curry leaf spice powder, aromatic and eaten with rice or idli.', 6.43, 20, NULL, 'KAR-PWD-003', NULL
FROM categories WHERE category_name = 'Karam Powders'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Kobbari Karam Podi', NULL, 'Coconut-based spice powder, a South Indian staple.', 6.5, 20, NULL, 'KAR-PWD-004', NULL
FROM categories WHERE category_name = 'Karam Powders'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Kothimeera Karam Podi', NULL, 'Coriander leaf spice powder, tangy and aromatic.', 6.43, 20, NULL, 'KAR-PWD-005', NULL
FROM categories WHERE category_name = 'Karam Powders'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Nuvvula Karam Podi', NULL, 'Sesame seed spice powder, nutty and rich.', 6.43, 20, NULL, 'KAR-PWD-006', NULL
FROM categories WHERE category_name = 'Karam Powders'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Palli Karam Podi', NULL, 'Peanut-based spice powder, a popular rice accompaniment.', 6.5, 20, NULL, 'KAR-PWD-007', NULL
FROM categories WHERE category_name = 'Karam Powders'
...
INSERT INTO products (category_id, product_name, scientific_name, description, price, stock_quantity, image_url, product_code, weight)
SELECT category_id, 'Pudina Karam Podi', NULL, 'Mint leaf spice powder, refreshing and spicy.', 6.43, 20, NULL, 'KAR-PWD-008', NULL
FROM categories WHERE category_name = 'Karam Powders'
